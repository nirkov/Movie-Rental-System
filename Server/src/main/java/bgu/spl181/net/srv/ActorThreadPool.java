...
public class ActorThreadPool {
    ...
    public ActorThreadPool(int threads) {
        ...
        //WeakHashMap - A map that does not consider its pointer to object, so if it happens
        // to hold the only pointer it will delete the object - in case a client
    ...
    public void submit(Object act, Runnable r) {    //act will be a handler - nonBlockingConnectionHandler type
        synchronized (act) {
